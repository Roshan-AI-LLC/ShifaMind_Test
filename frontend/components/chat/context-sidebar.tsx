...
export function ContextSidebar({ context, onClose, onClear }: ContextSidebarProps) {
  return (
    <div className="w-full sm:w-80 bg-muted border-r border-border rounded-lg overflow-hidden flex flex-col">
      ...
      {onClear && (
        <div className="p-3 border-t border-border">
          <button
            type="button"
            onClick={onClear}
            className="w-full text-xs text-foreground-muted hover:text-foreground py-2 rounded-lg hover:bg-secondary transition-colors"
          >
            Dismiss context
          </button>
        </div>
